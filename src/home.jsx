...
import pnng from '../public/pnggpugugugg.png';
import cu from '../public/nvidia-cuda-logo.avif';
import tf from '../public/tensor-flow-logo.avif';
import pt from '../public/pytorch-logo.avif';
import ju from '../public/jupyter-logo.avif';
    ...
    return (
        ...
        <div className="section" id="section2">
            ...
            <div className="gpuu11">
                ...
                {[...Array(5)].map((_, index) => (
                <img key={index} src={pnng} alt="GPU" /> // Replace with your image path
                ))}
            </div>
